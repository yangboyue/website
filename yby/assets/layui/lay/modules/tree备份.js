layui.define("form", function(e) {
    ...
    g.prototype.render = function() {
        ...
        if (r[0]) {
            if (a.showSearch && n.prepend('<input type="text" class="layui-input layui-tree-search" placeholder="请输入关键字进行过滤">'),
            e.key = a.id || e.index,
            e.elem = n,
            ...
            var c = l.children && l.children.length > 0
              ...
              , h = i(['<div data-id="' + l.id + '" class="layui-tree-set' + (l.spread ? " layui-tree-spread" : "") + (l.checked ? " layui-tree-checkedFirst" : "") + '">', "<div " + (r.drag && !l.fixed ? 'draggable="true"' : "") + ' class="layui-tree-entry">', '<div class="layui-tree-main">', function() {
                ...
                var e = {
                    ...
                    state: '<i class="layui-icon layui-icon-chart-screen" data-type="state">报文</i>'
                }
    ...
    g.prototype.spread = function(e, a) {
        ...
        k.on("click", function(i) {
            ...
            if (a[0]) {
                ...
                g = "normal";
            r.operate && r.operate({ open: e.hasClass(v), elem: e, type: "state" })
        }),
        m.on("click", function() {
            var n = i(this);
            n.hasClass(d) || (g = e.hasClass(v) ? r.onlyIconControl ? "open" : "close" : r.onlyIconControl ? "close" : "open",
            r.click && r.click({
                elem: e,
                state: g,
                data: a
    ...
    g.prototype.checkClick = function(e, a) {
        ...
        t.on("click", 'input[name="layuiTreeCheck"]+', function(l) {
            ...
            var t = i(this).prev()
              , d = t.prop("checked");
            t.prop("disabled") || (n.setCheckbox(e, a, t),
            r.oncheck && r.oncheck({
                elem: e,
                checked: d,
                data: a
    ...
    g.prototype.operate = function(e, a) {
        ...
        l.children(".layui-tree-btnGroup").on("click", ".layui-icon", function(l) {
            ...
            if ("add" == f) {
                g[0] || (r.showLine ? (d.find("." + c).addClass("layui-tree-icon"),
                d.find("." + c).children(".layui-icon").addClass(o).removeClass("layui-icon-file")) : d.find(".layui-tree-iconArrow").removeClass(t),
                e.append('<div class="layui-tree-pack"></div>'));
                var b = r.operate && r.operate(x)
                  , w = {};
                if (w.title = r.text.defaultNodeName,
                w.id = b,
                ...
                r.showLine)
                    if (g[0])
                        ...
                        1 == L ? (T.children("." + y).addClass(m),
                        T.children("." + y).children("." + s).removeClass(C),
                        e.children("." + y).addClass(m),
                        N.removeClass(k),
                        N.children("." + s).last().children("." + y).children("." + s).last().addClass(C)) : e.children("." + y).children("." + s).addClass(C)
                    }
                if (!r.showCheckbox)
                    return;
    ...
    g.prototype.drag = function() {
        ...
        e.elem.on("dragend", "." + u, function(n) {
            ...
            var S = function(n) {
                if (T || L || e.elem.children("." + s).last().children("." + y).children("." + s).last().addClass(C),
                !T)
                    return void d.removeClass("layui-tree-setHide");
                if (1 == H)
                    a.showLine ? (n.find("." + c).removeClass("layui-tree-icon"),
                    n.find("." + c).children(".layui-icon").removeClass(h).addClass("layui-icon-file"),
                    q.addClass(k),
                    q.children("." + s).children("." + y).each(function() {
                        i(this).children("." + s).last().addClass(C)
                    ...
                    if (a.showLine) {
                        ...
                        1 == r ? (d.children("." + y)[0] || (N.removeClass(k),
                        I.children("." + y).addClass(m),
                        I.children("." + y).children("." + s).removeClass(C)),
                        N.children("." + s).last().children("." + y).children("." + s).last().addClass(C),
                        L || n.parents("." + s)[0] || n.next()[0] || N.children("." + s).last().addClass(C)) : !L && d.hasClass(C) && N.children("." + s).last().addClass(C)
                    }
                    if (a.showCheckbox) {
                        var l = function(a) {
                            if (a) {
            ...
            g.each(function() {
                if (0 != i(this).height()) {
                    ...
                    if (r > n && r < n + 15) {
                        ...
                        i(this).find("." + c).eq(0).children(".layui-icon").addClass(o).removeClass("layui-icon-file")) : i(this).find(".layui-tree-iconArrow").removeClass(t),
                        i(this).append('<div class="layui-tree-pack"></div>')),
                        i(this).children("." + y).append(d),
                        S(A),
                        a.showLine) {
                            var l = i(this).children("." + y).children("." + s);
                            if (d.children("." + y).children("." + s).last().addClass(C),
                            1 == l.length) {
                                ...
                                1 == v ? (h.children("." + y).addClass(m),
                                h.children("." + y).children("." + s).removeClass(C),
                                i(this).children("." + y).addClass(m),
                                g.removeClass(k),
                                g.children("." + s).last().children("." + y).children("." + s).last().addClass(C).removeClass("layui-tree-setHide")) : i(this).children("." + y).children("." + s).addClass(C).removeClass("layui-tree-setHide")
                            } else
                                d.prev("." + s).hasClass(C) ? (d.prev("." + s).removeClass(C),
                                d.addClass(C)) : (d.removeClass("layui-tree-setLineShort layui-tree-setHide"),
                                d.children("." + y)[0] ? d.prev("." + s).children("." + y).children("." + s).last().removeClass(C) : d.siblings("." + s).find("." + y).each(function() {
                                    i(this).children("." + s).last().addClass(C)
                                })),
                    ...
                    if (r < n) {
                        ...
                        a.showLine) {
                            ...
                            if (b[0]) {
                                ...
                                1 == v ? T[0] && (h.children("." + y).addClass(m),
                                h.children("." + y).children("." + s).removeClass(C),
                                L.children("." + y).children("." + s).last().addClass(C).removeClass(m)) : d.children("." + y).children("." + s).last().addClass(C),
                            ...
                            T[0] || (d.addClass("layui-tree-setHide"),
                            d.children("." + y).children("." + s).last().removeClass(C))
                        }
                    ...
                    if (r > w)
                        return e.elem.children("." + s).last().children("." + y).addClass(m),
                        e.elem.append(d),
                        S(A),
